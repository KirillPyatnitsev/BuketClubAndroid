package com.opendev.buket.client.consts;
...
public class Fields {
    ...
    public static final String RATE = "cached_rating";
    ...
    public static final String DAY_PERFORM = "day_perform";

    public static final String TASK_ID = "task_id";
    public static final String TRAN = "push_notification";
    ...
    public static final String PERFORM_AT = "perform_at";
    public static final String PRICE = "price";
    public static final String TITLE = "title";
    public static final String JOB_DESCRIPTION = "job_description";
    public static final String TIME_CREATION = "time_creation";
    public static final String TIME_PERFORM_END = "time_perform_end";
