...
public class Rest {
    ...
    public static final String FLOWER_TYPE_ID = "flower_type_id";
    public static final String FLOWER_COLOR_ID = "flower_color_id";
    public static final String DAY_EVENT_ID = "day_event_id";
